              ...
              {departments.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-4 py-12 text-center">
                    <Building2 size={48} className="text-[var(--text-muted)] mx-auto mb-4 opacity-30" />
                ...
                departments.map((dept, idx) => (
                  <tr key={dept.id} className="hover:bg-[#f8fafc] dark:hover:bg-[#0f172a] transition-colors">
                    ...
                    <td className="px-4 py-3 text-sm text-[var(--text-primary)] font-medium">{dept.name}</td>
                    <td className="px-4 py-3 text-sm text-[var(--text-secondary)]">{dept.description}</td>
