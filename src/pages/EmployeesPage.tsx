          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-1 items-center">
              <button
                ...
                disabled={page === 1}
                className="p-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#1f2a3d] rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                <ChevronLeft size={16} />
              </button>
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
                        page === pageNum
                          ...
                          : "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#1f2a3d]"
                      }`}
                    >
                      {pageNum}
                    </button>
