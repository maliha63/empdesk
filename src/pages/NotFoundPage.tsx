      ...
      <div className="max-w-2xl w-full">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <div className="relative">
            ...
            <div className="relative bg-linear-to-br from-brand-500 to-blue-600 p-6 rounded-2xl">
          ...
          <div className="space-y-4">
            <h1 className="text-7xl font-bold bg-linear-to-r from-brand-600 to-blue-600 bg-clip-text text-transparent">
              404
            </h1>
