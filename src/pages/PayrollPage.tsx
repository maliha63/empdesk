      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-[#111827] border border-[var(--border)] rounded-2xl p-5">
            ...
            <p className="text-[11px] text-[var(--text-muted)] mt-2">Monthly total for {mockPayroll.length} employees</p>
          </div>
          ...
          <div className="bg-white dark:bg-[#111827] border border-[var(--border)] rounded-2xl p-5">
            ...
            <p className="text-[11px] text-[var(--text-muted)] mt-2">{Math.round((paidCount / mockPayroll.length) * 100)}% of workforce</p>
          </div>
          ...
          <div className="bg-white dark:bg-[#111827] border border-[var(--border)] rounded-2xl p-5">
            ...
            <p className="text-[11px] text-[var(--text-muted)] mt-2">Awaiting payment processing</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {mockPayroll.map((record) => (
            <div
              key={record.name}
              className="bg-white dark:bg-[#111827] border border-[var(--border)] rounded-2xl p-5 hover:shadow-lg transition-all"
            >
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs text-[var(--text-muted)] mt-1">{record.department}</p>
                </div>
                <span
              ...
              <div className="space-y-3 mb-4 pb-4 border-b border-[var(--border)]">
                <div className="flex justify-between items-center">
                  <span className="text-xs text-[var(--text-muted)]">Net Salary</span>
                ...
                <div className="flex justify-between items-center text-xs">
                  <span className="text-[var(--text-muted)]">Last Paid</span>
                  <span className="text-[var(--text-primary)] font-medium">
          ...
          <div className="space-y-5">
            ...
            <div className="border-t border-[var(--border)] pt-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  <span className="text-[var(--text-secondary)]">Bonuses</span>
                  <span className="font-medium text-emerald-600">
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <p className="text-xs text-[var(--text-muted)] mb-1">Net Salary</p>
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              ...
              <div className="bg-gray-50 dark:bg-[#0f172a] rounded-lg p-3">
                <p className="text-xs text-[var(--text-muted)] mb-1">Last Paid</p>
                <p className="text-sm font-semibold text-[var(--text-primary)]">
